...
function Market() {
    ...
    const getItems = async (haswallet, wallet) => {
        ...
        itemsList.push({
            ...
            seller: "test",
            name: "ATV",
            image: "http://3.bp.blogspot.com/-YflWqUWYhgU/UOfTX7RgVXI/AAAAAAAADfU/as0aXR6y-RI/s1600/2013-Yamaha-Grizzly-450-Auto-4x4-EPS-atv-pictures-1.jpg",
            score: 3, 
            tag: "ticket",
            description: "2013 Yamaha Grizzly 450 Auto 4x4 EPS"
        ...
        itemsList.push({
            ...
            seller: "test",
            name: "Brand new RV",
            image: "https://s-media-cache-ak0.pinimg.com/originals/59/a1/a1/59a1a1ebe6f30431f0345b24207744f8.jpg",
            score: 1, 
            tag: "nft",
            description: "Bernie Mac house on the show"
        ...
        itemsList.push({
            ...
            price: 5000,
            seller: "test",
            name: "Side by Side ATV",
            image: "http://images.honda.ca/models/S/Models/2018/pioneer_700_2/sxsca_modelNav.png",
            score: 6, 
            tag: "vp",
            description: "Yamaha Introduces New 2016 Wolverine Side-by-Side Models"
                ...
                <nav class="nav">
                    <ul class="nav nav-pills" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="cnfts-tab" data-bs-toggle="tab" data-bs-target="#cnfts" type="button" role="tab" aria-controls="cnfts" aria-selected="true">RVs</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="ticket-tab" data-bs-toggle="tab" data-bs-target="#ticket" type="button" role="tab" aria-controls="ticket" aria-selected="false">ATV</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="vp-tab" data-bs-toggle="tab" data-bs-target="#vp" type="button" role="tab" aria-controls="vp" aria-selected="false">Side-By-Side</button>
                        </li>
                        ...
                        <div class="tab-pane fade show active" id="cnfts" role="tabpanel" aria-labelledby="cnfts-tab">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark">
                                    ...
                                    <li><button class="dropdown-item disabled" onClick={onChangeSortedAi}>Price</button></li>
                                    <li><button class="dropdown-item disabled" onClick={onChangeSortedAi}>Color</button></li>
